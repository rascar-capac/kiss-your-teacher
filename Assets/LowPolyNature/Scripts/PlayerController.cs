...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private EggBehaviour egg = null;
    [SerializeField] [Range(1f, 100f)] private float throwForce = 10f;
    ...
    void Update()
    {
        ...
        {
            gameOverPanel.transform.GetChild(0).GetComponent<Text>().text = "GAME OVER, score: " + EggsCount;
        ...
        //    if (EggsCount > 0)
        //    {
        //        EggBehaviour newEgg = Instantiate(egg, new Vector3(transform.position.x, transform.position.y + transform.up.y, transform.position.z + transform.forward.z * 2), Quaternion.identity);
        //        newEgg.GetComponent<Rigidbody>().AddForce(transform.forward * throwForce);
        //        EggsCount--;
        //        if (EggsCount < 0)
        //        {
        //            EggsCount = 0;
